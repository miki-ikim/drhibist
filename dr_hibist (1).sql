...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2020 at 11:48 AM
...
(1, 'barkot', 'bereket', 2, 'M', 6565134, 1, '2020-12-29', 100, 500, 500),
(2, 'israel', 'kefyalew', 14, 'm', 915072024, 2, '2020-11-27', 100, 0, 0),
...
(19, 'miki', 'ikim', 12, 'm', 9123156, 12, '2020-11-30', 0, 0, 0),
(20, 'lili', 'ilil', 11, 'f', 91314562, 75, '2020-11-30', 0, 0, 0);
...
INSERT INTO `store` (`ids`, `name`, `cost`, `quantity`) VALUES
(1, 'pills', 234, 10),
(2, 'prastamol', 111, 111),
(3, 'amoksaslin', 111, 121);
...
--
ALTER TABLE `drug`
  MODIFY `idD` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `store`
  MODIFY `ids` int(22) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
